...
/**
 * Neighborhood filter form base class.
 *
 * @package    sf_icox
 * @subpackage filter
 * @author     pinika
 ...
 */
abstract class BaseNeighborhoodFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('neighborhood_filters[%s]');
