...
/**
 * OperationRealProperty filter form base class.
 *
 * @package    sf_icox
 * @subpackage filter
 * @author     pinika
 ...
 */
abstract class BaseOperationRealPropertyFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('operation_real_property_filters[%s]');
