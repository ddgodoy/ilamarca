<div class="content">
	...
	<div class="leftside" style="margin-left:260px;">
		...
		<?php endif; ?>
		<?php if ($ok): ?>
			<div class="mensajeSistema ok"><?php echo __('Company info updated successfully') ?></div>
		<?php endif; ?>
		<h1 class="titulos">
			<?php echo __('Update company info'); ?>
		</h1>
		<form enctype="multipart/form-data" method="post" action="<?php echo url_for('home/myCompany') ?>">
