<div class="content">
	<div class="leftside">
		...
		<fieldset>
			<table width="100%" cellspacing="4" cellpadding="2" border="0">
				<tr>
					...
					<td width="90%" class="text_detail"><?php echo $oValue->GeoZone->getName() ?></td>
				</tr>
				<tr>
		...
		<div style="padding-top:10px;" class="botonera">
			<input type="button" onclick="document.location='<?php echo url_for('city/edit').'?id='.$id ?>';" value="<?php echo __('Edit') ?>" class="boton" />
			<input type="button" onclick="document.location='<?php echo url_for('city/index') ?>';" value="<?php echo __('Continue to list') ?>" class="boton" />
		</div>
	</div>
	<div class="clear"></div>
</div>