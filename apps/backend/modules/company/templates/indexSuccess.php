...
<div class="content">
  ...
  <div class="mapa">
		<a href="<?php echo url_for('home/index') ?>"><strong><?php echo __('Home') ?></strong></a>&nbsp;&gt;&nbsp;<?php echo __('Companies') ?>
	</div>
  <h1 class="titulos">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="listados">
      <tr>
      	<?php if (count($oList) > 0): ?>
	        <th width="30%"><a href="<?php echo $head_link.'&o=name&s='.$sort ?>"><?php echo __('Name') ?></a></th>
	        <th width="30%"><a href="<?php echo $head_link.'&o=email&s='.$sort ?>"><?php echo __('Email') ?></a></th>
	        <th width="32%"><a href="<?php echo $head_link.'&o=address&s='.$sort ?>"><?php echo __('Address') ?></a></th>
	        <th width="4%"></th>
	        <th width="4%"></th>
        <?php else: ?>
