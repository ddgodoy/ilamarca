					...
					<?php echo Common::fillSimpleSelect($db_geo_zones, $geo_zone) ?>
                        ...
                        <div class="rowElem padding-bottom5">
                            <table cellpadding="0" cellspacing="0" style="width: 75px">
                                    ...
                                    <tr>
                                            <td><input type="text" name="p_from" class="et_input" value="<?php echo $p_desde?>" style="width:75px;text-align:right;" onkeypress="return onlyDecimal(this, event);"/></td>
                                            <td width="10"></td>
                                            <td><input type="text" name="p_to" class="et_input" value="<?php echo $p_hasta ?>" style="width:75px;text-align:right;" onkeypress="return onlyDecimal(this, event);"/></td>
                                            <td width="10"></td>
                                            <td>
                                                    <select name="currency" class="et_input" style="width:80px; height: 27px; text-align:center;">
                        ...
                        <div class="boton" style="padding: 15px;">
